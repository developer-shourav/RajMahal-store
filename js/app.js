  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h2>Price: $ ${product.price}</h2>
       <p class =ms-0><i class="fas fa-star "></i> ${product.rating.rate} rating <span style="margin-left:40px">  
        <i class="fas fa-users"></i> ${product.rating.count} Total reviews
       </span> </p>
       <p> <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now "><i class="fas fa-shopping-cart"></i>  add to cart</button></P>
      <button id="details-btn" class="details-btn"><i class="fas fa-info-circle"></i> Details</button></div>
      `;
...
const addToCart = (id, price) => {
  ...
  /* -----------------------------------------------------------
  Fixing total Price bug and call The total price showing funciton 
  ------------------------------------------------------------- */
  updateTotal()
...
const getInputValue = (id) => {
  ...
  /* ---------------------------------------------------------
    chandged into ParseFloat tor geting desired 2 decimal value
  ------------------------------------------------------------- */
...
const updatePrice = (id, value) => {
  ...
  /* -----------------------------------------------------
   removing Math.round and used toFixed to get 2 decimal 
  -------------------------------------------------------- */
...
const updateTotal = () => {
  ...
  /* -----------------------------------------------------
    Used toFixed to get limited decimal number
  -------------------------------------------------------- */
